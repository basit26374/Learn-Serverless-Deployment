...
from counter_app.views.count import GetCount, PostCount, SendCount, SendBulkCount, GenerateRandomCount, Response, UnhandledException
...
count_api.add_resource(UnhandledException, '/exception')